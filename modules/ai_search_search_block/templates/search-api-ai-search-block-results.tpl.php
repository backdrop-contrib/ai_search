 ...
 *
 * @see template_preprocess_ai_search_search_block_results()
 */
?>
<div class="search-api-ai-search-block-results">
  <?php if (!empty($query)): ?>
    <h2><?php print t('Search results for "@query"', ['@query' => $query]); ?></h2>
  <?php endif; ?>
  ...
  <?php else: ?>
    <div class="search-api-ai-search-block-no-results">
      <p><?php print t('No results found for "@query". Please try a different search.', ['@query' => $query]); ?></p>
    </div>
  <?php endif; ?>
</div>
